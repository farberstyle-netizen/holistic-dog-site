...
// CRITICAL: Verify this matches your existing password hashing method!
// Run this SQL to check: SELECT password_hash, LENGTH(password_hash) FROM users LIMIT 1;
// - If 64 chars hex → SHA-256 (this code is correct)
// - If 60 chars starting with $2 → bcrypt (UPDATE THIS FUNCTION)
// - If < 30 chars → plain text (UPDATE THIS FUNCTION)
